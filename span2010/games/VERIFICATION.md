...
- 94 automated assertions passed for answer banks, repairs, distractors, negation, conservative typos, progressive hints, exploration gates, full completion, transcript, optional local save, and restart.
...
Expanded the answer bank to accept common short replies including «Sí», «Sí, tengo una reserva», «En el taxi», and «En taxi», following an observed live playthrough.
